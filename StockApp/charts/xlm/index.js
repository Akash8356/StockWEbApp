...
fetch(`http://127.0.0.1:9665/fetchAPI?endpoint=https://api.binance.com/api/v3/klines?symbol=XLMUSDT&interval=1m&limit=1000`)
  .then(res => res.json())
  .then(data => {
...
//Dynamic Chart
const socket = io.connect('http://127.0.0.1:4006/');
